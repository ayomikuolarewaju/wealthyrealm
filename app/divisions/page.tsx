...
const services = [
  {
    id: "food", title: "Food Delivery", subtitle: "WealthyRealm Int Eats",
  ...
  {
    id: "realestate", title: "Real Estate", subtitle: "WealthyRealm Int Properties",
    ...
    href: "https://wealthafricart.netlify.app/categories/real-estate",
  },
];
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
            {services.map((s, idx) => {
              ...
              return (
                <Link key={s.id} href={s.href} className="group bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
